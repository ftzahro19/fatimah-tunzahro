...
<html>
<head>
<title>LAPORAN JASA MEDIS</title>
...
<body>
<h3 align="center">LAPORAN JASA MEDIS </h3>
<h4 align="center">Tanggal <?php echo $bydate1;?> sd <?php echo $bydate2;?>
<form>
<table align="center" width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
<?php
$username= $_SESSION['klinik'];
$query1 = "SELECT * FROM user,tm WHERE user.username=tm.operator AND tanggal_tm>='$bydate1' AND tanggal_tm<='$bydate2' AND operator='$username' GROUP BY operator";
...
$query3 = "SELECT SUM(jasa_tm) FROM tm WHERE tanggal_tm>='$bydate1' AND tanggal_tm<='$bydate2' AND operator='$username'";
