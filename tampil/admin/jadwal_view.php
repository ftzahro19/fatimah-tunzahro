...
<body>
  <table align="center" width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
    <tr>
      <td colspan="9" bgcolor="#CCCCCC"><div align="left"><strong>DAFTAR KATEGORI SDM </strong></div></td>
    </tr>
	<tr bgcolor="#FFFFFF">
      <td  colspan="9"><a href="tambah_jadwal.php?id_dokter=<?php echo $_SESSION['klinik'];?>">Tambah</a></td>
    </tr>
    <tr bgcolor="#FFFFFF">
...
<?php 
	$sql = "SELECT * FROM jadwal_praktek,user WHERE jadwal_praktek.kd_dokter=user.username AND user.status='Aktif' GROUP BY kd_dokter";
  ...
  ?>
    <tr bgcolor="#FFFFFF" valign="top">
      ...
      <td><div align="center"><a href="jadwal_edit.php?kdubah=<?php echo $data['kd_dokter']; ?>" onClick="NewWindow(this.href,'name','800','400','yes');return false">Edit</a> 
      | <a href="jadwal_hapus.php?kdhapus=<?php echo $data['kd_dokter']; ?>" class="style1">Hapus</a></div></td>
      <?php
}
?>
    </tr>
