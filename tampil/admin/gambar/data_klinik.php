...
<tr bgcolor="#FFFFFF"> 
  <td width="17%" rowspan="8" valign="top">&nbsp;<?php
    if ($data['photo']=="") {
  ...
  <td>  
    <input type="text" name="nama_klinik" value="<?php echo $data['nama_klinik']; ?>">
  </td>
</tr>
<tr bgcolor="#FFFFFF"> 
...
<tr bgcolor="#FFFFFF">
  <td>Fax</td>
  <td>
    <input type="text" name="fax" value="<?php echo $data['fax']; ?>"></td>
</tr>
  </form>
</table>
</body>
