...
include "../../tampil/poliklinik/tab_order_poli_edit.php";
...
<body id="tab2">
  ...
  <a href="lab_view.php?kd_kunjungan=<?php echo $kd_kunjungan;?>" onClick="NewWindow(this.href,'name','800','400','yes');return false"><b>+ Tambah Resep </b>
</a>
 <tr bgcolor="#FFFFFF">
...
$query = "SELECT * FROM data_pasien,reg,lab WHERE data_pasien.prn=reg.prn AND reg.selesai!='Selesai' AND reg.kd_kunjungan=lab.kd_kunjungan AND lab.status='Selesai' GROUP BY lab.kd_kunjungan";
...
?>
  <tr onMouseOver="this.bgColor='lightyellow'" onMouseOut="this.bgColor='#ffffff'" bgcolor="#ffffff">
    ...
    <?php $i++;?></td>
    <td class="style1"><a href="lab_view.php?kd_kunjungan=<?php echo $data['kd_kunjungan'];?>"><b>Lihat</b></a></td>
  </tr>
  <?php
}
?>
