...
$query = "SELECT * FROM data_pasien,reg,lab WHERE data_pasien.prn=reg.prn AND reg.selesai!='Selesai' AND reg.kd_kunjungan=lab.kd_kunjungan AND lab.status='Order' GROUP BY lab.kd_kunjungan";
...
?>
  <tr onMouseOver="this.bgColor='lightyellow'" onMouseOut="this.bgColor='#ffffff'" bgcolor="#ffffff">
    ...
    <?php $i++;?></td>
    <td class="style1"><a href="lab_input.php?kd_kunjungan=<?php echo $data['kd_kunjungan'];?>" onClick="NewWindow(this.href,'name','800','400','yes');return false"><b>Proses </b>
</a></td>
  </tr>
  <?php
}
