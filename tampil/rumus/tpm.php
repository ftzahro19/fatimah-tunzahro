...
<title>:: KALKULATOR DOSIS OBAT</title>
...
bb = document.frmAdd.txtbb.value;
document.frmAdd.aliran.value = ( dosis * bb * cairan * 60 ) / ( isi * 1000 );
document.frmAdd.txttetesan.value = ( dosis * bb * cairan *  faktor) / ( isi * 1000);
}
function stopCalc(){
...
<tr>
<td height="78" colspan="3" align="center"><p><strong>KALKULATOR DOSIS OBAT (MENGGUNAKAN BERAT BADAN) </strong></p>
  </td>
</tr>
<tr>
...
microgram/kgbb/menit</td>
</tr>
<tr>
<td>Berat Badan Pasien</td>
<td>:</td>
<td><input type="text" name="txtbb" size="10" onFocus="startCalc();" onBlur="stopCalc();">
kg</td>
</tr>
<tr>
<td>Jumlah cairan</td>
