...
?>
  <tr onMouseOver="this.bgColor='lightyellow'" onMouseOut="this.bgColor='#ffffff'" bgcolor="#ffffff">
    <td class="style1"><a href="reg_edit.php?kd_kunjungan=<? echo $data['kd_kunjungan'];?>"><? echo $data['nama'];?></a></td>
    <td class="style1"><div align="center"><a href="reg_edit.php?kd_kunjungan=<? echo $data['kd_kunjungan'];?>"><? echo $data['tgl_lahir'];?></a></div></td>
    <td class="style1"><div align="center"><a href="reg_edit.php?kd_kunjungan=<? echo $data['kd_kunjungan'];?>"><? echo $data['prn'];?></a></div></td>
    <td class="style1"><a href="reg_edit.php?kd_kunjungan=<? echo $data['kd_kunjungan'];?>"><? echo $data['tgl_reg'];?></a></td>
    <td class="style1"><a href="reg_edit.php?kd_kunjungan=<? echo $data['kd_kunjungan'];?>"><? echo $data['jam_reg'];?></a></td>
    <td class="style1"><div align="center"><a href="reg_edit.php?kd_kunjungan=<? echo $data['kd_kunjungan'];?>"></a>
     <a href="reg_edit.php?kd_kunjungan=<? echo $data['kd_kunjungan'];?>"><? echo $data['klinik1'];?></a></div></td>
    <td class="style1"><div align="center"><a href="reg_edit.php?kd_kunjungan=<? echo $data['kd_kunjungan'];?>"><? echo $data['klinik2'];?></a></div></td>
<td class="style1"><div align="center"><a href="reg_edit.php?kd_kunjungan=<? echo $data['kd_kunjungan'];?>"><? echo $data['klinik3'];?></a></div></td>
  </tr>
  <?php
}
?>
