...
$sql_tool = "SELECT * FROM toolkit WHERE kd_kunjungan='$kd_kunjungan'";
$qry_tool = mysql_query($sql_tool);
$data_tool = mysql_fetch_array($qry_tool);
?>
