...
<body id="tab3">
  ...
  <table align="left" width="99%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
    <tr bgcolor="#FFFFFF">
   	...
   	<td width="66%" align="center" bgcolor="#D9E8F3"><b>Nama rad</b></td>
...
{
?>
   	<td width="3%" align="center" bgcolor="#FFFFFF"><input type="checkbox" value="<?php echo $data['kd_rad'];?>" name="lx<?php echo $i;?>" />
	...
	<input name="dr_pengirim" type="hidden" value="<?php echo $_SESSION['klinik'];?>"/>
   	...
   	<td width="66%" align="left" bgcolor="#FFFFFF"><input type="hidden" size="4" value="<?php echo $data['nama_rad'];?>" name="nama_rad<?php echo $i;?>" />
	<?php echo $data['nama_rad'];?></td>
	<td width="31%" align="left" bgcolor="#FFFFFF"><input type="text" size="6" value="<?php echo $data['harga_rad'];?>" name="harga_rad<?php echo $i;?>" /><?php $i++;?></td>
   	</tr>
    <?php
}
?>
