...
<table align="center" width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
	...
	<tr bgcolor="#FFFFFF">
      ...
      <td width="13%" bgcolor="#D9E8F3"><div align="center"><strong>Tanggal Daftar</strong></div></td>
...
<?php 
  ...
  ?>
	...
	<td><?php echo $no++ ;?> </td>
      <td><a href="../operator/lap_poli.php?kd_kunjungan=<?php echo $data3['kd_kunjungan']; ?>"><?php echo $data3['nama'];?> [<?php echo $data3['prn'];?>]</a></td>
      <td><a href="../operator/lap_poli.php?kd_kunjungan=<?php echo $data3['kd_kunjungan']; ?>"><?php echo $data3['tgl_reg'];?></a></td>
      <td><a href="../operator/lap_poli.php?kd_kunjungan=<?php echo $data3['kd_kunjungan']; ?>"><?php echo $data3['jam_reg'];?></a></td>
      <td><a href="../operator/lap_poli.php?kd_kunjungan=<?php echo $data3['kd_kunjungan']; ?>"><?php echo $data3['nama_klinik'];?></a></td>      
      <td>
	<?php
	$dokter = $data3['dokter'];
	...
	$data4 =mysql_fetch_array($qry4);?>
	  <a href="../operator/lap_poli.php?kd_kunjungan=<?php echo $data3['kd_kunjungan']; ?>">
	  <?php echo $data4['nama_user'];?></a></td>
<td width="12%" bgcolor="#FFFFFF">
<div align="center"><a href="../operator/lap_poli.php?kd_kunjungan=<?php echo $data3['kd_kunjungan']; ?>"><?php echo $data3['selesai'];?></a></div></td>
</tr>
<?php
}
...
<tr onMouseOver="this.bgColor='lightyellow'" onMouseOut="this.bgColor='#ffffff'" bgcolor="#ffffff" span class="style1">
	<td><?php echo $no++ ;?> </td>
      <td><a href="../operator/lap_poli_edit.php?kd_kunjungan=<?php echo $data3['kd_kunjungan']; ?>"><?php echo $data3['nama'];?> [<?php echo $data3['prn'];?>]</a></td>
      <td><a href="../operator/lap_poli_edit.php?kd_kunjungan=<?php echo $data3['kd_kunjungan']; ?>"><?php echo $data3['tgl_lahir'];?></a></td>
      <td><a href="../operator/lap_poli_edit.php?kd_kunjungan=<?php echo $data3['kd_kunjungan']; ?>"><?php echo $data3['tanggal'];?></a></td>
      <td><a href="../operator/lap_poli_edit.php?kd_kunjungan=<?php echo $data3['kd_kunjungan']; ?>"><?php echo $data3['nama_klinik'];?></a></td>      
      <td><a href="../operator/lap_poli_edit.php?kd_kunjungan=<?php echo $data3['kd_kunjungan']; ?>">
	  <?php
	$dokter = $data3['dokter'];
	$sql4 = "SELECT * FROM user WHERE username='$dokter'";
    $qry4 = mysql_query($sql4, $koneksi) or die ("gagal Query");
	$data4 =mysql_fetch_array($qry4);?> <?php echo $data4['nama'];?></a></td>
      <td width="12%" bgcolor="#FFFFFF">
<div align="center"><a href="../operator/lap_poli_edit.php?kd_kunjungan=<?php echo $data3['kd_kunjungan']; ?>"><?php echo $data3['selesai'];?></a></div></td>
</tr>
<?php
}
}
