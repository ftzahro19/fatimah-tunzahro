...
function calc(){
pribadi1 = document.form1.pribadi1.value;
pribadi2 = document.form1.pribadi2.value;
pribadi3 = document.form1.pribadi3.value;
pribadi4 = document.form1.pribadi4.value;
pribadi5 = document.form1.pribadi5.value;
pribadi6 = document.form1.pribadi6.value;
pribadi7 = document.form1.pribadi7.value;
pribadi8 = document.form1.pribadi8.value;
pribadi9 = document.form1.pribadi9.value;
pribadi10 = document.form1.pribadi10.value;
document.form1.total.value = pribadi1+pribadi2+pribadi3+pribadi4+pribadi5+pribadi6+pribadi7+pribadi8+pribadi9+pribadi10;
}
function stopCalc(){
