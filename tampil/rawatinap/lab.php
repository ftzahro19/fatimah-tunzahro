...
$q=$_REQUEST['q'];
$query = "SELECT * FROM lab_db WHERE nama_lab LIKE '%$q%'";
$hasil = mysql_query($query);
$i = 0;
while ($data = mysql_fetch_array($hasil))
{
?>
    <td width="3%" align="center" bgcolor="#FFFFFF"><input type="checkbox" value="<?php echo $data['kd_lab'];?>" name="lab<?php echo $i;?>" /></td>
	...
	<td width="13%" align="left" bgcolor="#FFFFFF"><input type="text" size="6" value="<?php echo $data['harga_lab'];?>" name="harga_lab<?php echo $i;?>" /></td>
