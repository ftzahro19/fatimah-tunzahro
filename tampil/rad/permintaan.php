...
$query = "SELECT * FROM data_pasien,reg,rad WHERE data_pasien.prn=reg.prn AND reg.selesai!='Selesai' AND reg.kd_kunjungan=rad.kd_kunjungan AND rad.status='Order' GROUP BY rad.kd_kunjungan";
...
?>
  <tr onMouseOver="this.bgColor='lightyellow'" onMouseOut="this.bgColor='#ffffff'" bgcolor="#ffffff">
    ...
    <?php $i++;?></td>
    <td class="style1"><a href="rad_input.php?kd_kunjungan=<?php echo $data['kd_kunjungan'];?>" onClick="NewWindow(this.href,'name','800','400','yes');return false"><b>Baca</b>
</a></td>
  </tr>
  <?php
}
