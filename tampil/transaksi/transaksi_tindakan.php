...
<body id="tab8" onLoad="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
...
$query = "SELECT * FROM reg,tm WHERE reg.kd_kunjungan=tm.kd_kunjungan AND tm.kd_kunjungan='$kd_kunjungan' AND tm.status_tm='Selesai'";
...
?>
  <tr onMouseOver="this.bgColor='lightyellow'" onMouseOut="this.bgColor='#ffffff'" bgcolor="#ffffff">
    ...
    <td class="style1">
	<input type="hidden" name="nama_item<?php echo $i;?>" value="<?php echo $data['nama_tm'];?>"><?php echo $data['nama_tm'];?>
	<input type="hidden" name="operator<?php echo $i;?>" value="<?php echo $data['operator'];?>"><?php echo $data['operator'];?>
	</td>
...
$query = "SELECT * FROM resep WHERE status='Selesai' AND kd_kunjungan='$kd_kunjungan'";
$hasil = mysql_query($query);
while ($data = mysql_fetch_array($hasil))
{
$harga = $data['harga'];
...
?>
  ...
  <tr bgcolor="#FFFFFF">
    <td bgcolor="#FFFFFF" align="center"></td>
    <td bgcolor="#FFFFFF" align="center"></td>
    <td bgcolor="#FFFFFF" align="right"><b>Total pembayaran  oleh asuransi:</b></td>
    <td bgcolor="#FFFFFF" align="right">&nbsp;</td>
    <td colspan="2" align="right" bgcolor="#FFFFFF"><b>
      <?php 
	$total_asuransi = $sub_total_asuransi1 + $sub_total_asuransi2;
  ...
  <tr bgcolor="#FFFFFF">
    <td bgcolor="#FFFFFF" align="center"></td>
    <td bgcolor="#FFFFFF" align="center"></td>
    <td bgcolor="#FFFFFF" align="right"><b>Total pembayaran oleh pasien :</b></td>
    <td bgcolor="#FFFFFF" align="right">&nbsp;</td>
    <td colspan="2" align="right" bgcolor="#FFFFFF"><b>
      <?php 
	$total_pribadi = $sub_total_pribadi1 + $sub_total_pribadi2;
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
    <td align="right" bgcolor="#FFFFFF">Terbilang :</td>
    <td colspan="3" align="right" bgcolor="#FFFFFF"><?php echo terbilang($grand_total);?> rupiah</td>
    </tr>
  <tr bgcolor="#FFFFFF">
...
<input name="button" type="button" class="noPrint" onClick="window.print()" value="Print">
  <input type="submit" name="Submit" value="Close and Print">
  </td>
</tr>
</table>
</form>
